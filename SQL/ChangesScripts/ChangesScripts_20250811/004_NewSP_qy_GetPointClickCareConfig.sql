...
USE [Utilities];
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('adt.qy_GetPointClickCareConfig'))
   DROP PROC [adt].[qy_GetPointClickCareConfig]
GO
CREATE PROCEDURE [adt].[qy_GetPointClickCareConfig]
/* -----------------------------------------------------------------------------------------------------------
   Procedure Name  :  qy_GetPointClickCareConfig
   Business Analyis:
   Project/Process :   
   Description     :  Get configuration settings for the 
                      'PointClickCare ADT' application.
...
----------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    SET @BatchDetailDescription = '010/190:  Populate KeyValueTable with call to [administration].[qy_GetApplicationSettings]'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
      ...
      EXEC [Admin].[Utilities].[administration].[qy_GetApplicationSettings] 'SimplifyVbcAdt', 'Default', 'PointClickCare', NULL, 'AppUser';
...
/*	
    [ReadDirectory]
*/
    SET @BatchDetailDescription = '020/190:  Populate @ReadDirectory'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
*/
    SET @BatchDetailDescription = '030/190:  Populate @InputFilenameContainsString'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
/*	
      ,[StartLineNumber]
*/
    SET @BatchDetailDescription = '040/190:  Populate @StartLineNumber'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
/*	
      ,[StartColumnNumber]
*/
    SET @BatchDetailDescription = '050/190:  Populate @StartColumnNumber'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
*/
    SET @BatchDetailDescription = '060/190:  Populate @InputFileArchiveDirectory'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
*/
    SET @BatchDetailDescription = '070/190:  Populate @OutputFileArchiveDirectory'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
*/
    SET @BatchDetailDescription = '080/190:  Populate @ToSimpleFileMoverReadDirectory'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
*/
    SET @BatchDetailDescription = '090/190:  Populate @SimplifyVbcAdtBaseWebApiUrl'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
*/
    SET @BatchDetailDescription = '100/190:  Populate @ExcelTemplateFullFilename'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
/*	
      ,[ImportArchiveFolder]
*/
    SET @BatchDetailDescription = '110/190:  Populate @ImportArchiveFolder'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
*/
    SET @BatchDetailDescription = '130/190:  Populate @BulkInsertConnectionString'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
/*	
      ,[BulkInsertDbName]
*/
    SET @BatchDetailDescription = '140/190:  Populate @BulkInsertDbName'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
*/
    SET @BatchDetailDescription = '150/190:  Populate @BulkInsertDbTableName'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
*/
    SET @BatchDetailDescription = '160/190:  Populate @BulkInsertBaseWebApiUrl'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
/*	
      ,[EmailBaseWebApiUrl]
*/
    SET @BatchDetailDescription = '170/190:  Populate @EmailBaseWebApiUrl'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
/*	
      ,[EmailFromAddress]
*/
    SET @BatchDetailDescription = '180/190:  Populate @EmailFromAddress'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
...
/*	
    [ReadDirectory]
      ...
      ,[EmailFromAddress]
*/
    SET @BatchDetailDescription = '190/190:  Populate @ReadDirectory'
    EXEC Admin.Utilities.logs.di_Batch @BatchOutID OUTPUT,  @BatchOutID, 'DetailStart', @BatchDetailDescription
