...
VALUES (@MyApplicationID
           ...
           ,'Default'
           ,''
           ,'\\ps-nas\NAS\SSS\VBC\1. Care Coordination\ADMIN ASSISTANT\ADT FEEDS\PointClickCare'
           ,1)
      ,(@MyApplicationID
           ,@MyProcessID
           ,'InputFilenameContainsString'
      ...
      ,(@MyApplicationID
           ...
           ,'Default'
           ,''
           ,'\\ps-nas\NAS\SSS\VBC\1. Care Coordination\ADMIN ASSISTANT\ADT FEEDS\PointClickCare\InputFileArchive'
           ,1)
      ,(@MyApplicationID
           ,@MyProcessID
           ,'OutputFileArchiveDirectory'
           ,'Default'
           ,''
           ,'\\ps-nas\NAS\SSS\VBC\1. Care Coordination\ADMIN ASSISTANT\ADT FEEDS\PointClickCare\OutputToAthenaArchive'
           ,1)
      ,(@MyApplicationID
           ,@MyProcessID
           ,'ToSimpleFileMoverReadDirectory'
           ,'Default'
           ,''
           ,'\\ps-nas\NAS\SSS\VBC\1. Care Coordination\ADMIN ASSISTANT\ADT FEEDS\PointClickCare\OutputToSummitADTProcessingArchive'
           ,1)
      ,(@MyApplicationID
           ,@MyProcessID
           ,'SimplifyVbcAdtBaseWebApiUrl'
      ...
      ,(@MyApplicationID
           ...
           ,'Default'
           ,''
           ,'\\ps-nas\NAS\SSS\VBC\1. Care Coordination\ADMIN ASSISTANT\ADT FEEDS\PointClickCare\PointClickCareTemplate\PointClickCare DAILY DROP TEMPLATE.xlsx'
           ,1)
      ,(@MyApplicationID
           ,@MyProcessID
           ,'ImportArchiveFolder'
           ,'Default'
           ,''
           ,'\\ps-nas\nas\SSS\IT\Shared\SSS ODS\ADT Feeds\PointClickCare'
           ,1)
      ,(@MyApplicationID
           ,@MyProcessID
           ,'BulkInsertConnectionString'
           ,'Default'
           ,''
           ,'Data Source=smg-dsdev05;Initial Catalog=SimplifyVbcAdt8;TrustServerCertificate=True;Integrated Security=False;User ID=AppUser;Password=SoMm1t!@'
           ,1)
      ,(@MyApplicationID
           ,@MyProcessID
           ,'BulkInsertDbName'
